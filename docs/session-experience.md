...
Practice timing shows P, DRIVER, TYRE, AGE, LAST, BEST, GAP, STINT, STOPS, and STATUS. GAP is the normalized provider classification delta. Normal running rows are quiet; IN PIT, STOPPED, and terminal classifications require lifecycle evidence. Narrow rows retain tyre, best lap, gap, and factual status.
