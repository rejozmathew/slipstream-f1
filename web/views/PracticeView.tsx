...
export function PracticeView({ timingWidth = 66, onTimingWidthChange = () => {}, state, replayAvailable, positionMode, viewingMode, onSelectDriver }: { timingWidth?: number; onTimingWidthChange?: (width: number) => void; state: RaceState; replayAvailable: boolean; positionMode: PositionMode; viewingMode: ViewingMode; onSelectDriver: (driverNumber: string) => void }) {
  ...
  return <><SessionSplit className="session-layout practice-layout session-desktop" timingWidth={timingWidth} onTimingWidthChange={onTimingWidthChange} timing={<TimingTower drivers={drivers} variant="practice" replayAvailable={replayAvailable} onSelectDriver={onSelectDriver} />} analysis={<div className="analysis-stack">
